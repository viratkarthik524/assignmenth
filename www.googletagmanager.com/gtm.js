    ...
    resource: {
      ...
      tags: [
        ...
        },
        {
          ...
          once_per_event: true,
          vtp_html:
            '\u003Cscript type="text/gtmscript"\u003Evar dr_event_type="view_item";if("undefined"!==typeof initialState\u0026\u0026initialState.data\u0026\u0026initialState.data.id){var id=initialState.data.id,dr_items=[];dr_items.push({id:id,google_business_vertical:"real_estate"});dataLayer.push({dr_event_type:dr_event_type,dr_items:dr_items,event:"dynamic_remarketing"})};\u003C/script\u003E',
          vtp_supportDocumentWrite: false,
          vtp_enableIframeMode: false,
          vtp_enableEditJsMacroBehavior: false,
          tag_id: 27,
        },
        {
          ...
          once_per_event: true,
          vtp_html:
            '\u003Cscript type="text/gtmscript"\u003Evar dr_event_type="add_to_cart";if("undefined"!==typeof initialState\u0026\u0026initialState.data\u0026\u0026initialState.data.id){var id=initialState.data.id,dr_items=[];dr_items.push({id:id,google_business_vertical:"real_estate"});dataLayer.push({dr_event_type:dr_event_type,dr_items:dr_items,event:"dynamic_remarketing"})};\u003C/script\u003E',
          vtp_supportDocumentWrite: false,
          vtp_enableIframeMode: false,
          vtp_enableEditJsMacroBehavior: false,
          tag_id: 30,
      ...
      predicates: [
        ...
        { function: "_eq", arg0: ["macro", 1], arg1: "dynamic_remarketing" },
        { function: "_eq", arg0: ["macro", 1], arg1: "gtm.init" },
        { function: "_cn", arg0: ["macro", 5], arg1: "form" },
        { function: "_eq", arg0: ["macro", 1], arg1: "submit" },
        { function: "_eq", arg0: ["macro", 1], arg1: "page_country" },
        { function: "_eq", arg0: ["macro", 1], arg1: "success_newleadform" },
        { function: "_eq", arg0: ["macro", 1], arg1: "search_page_new_viewed" },
      ],
      rules: [
        [
          ["if", 0, 1],
...
*/
            ...
            if (h instanceof rb)
              if (h.length() !== m.length())
                ...
                for (var n = 0; n < m.length(); n++)
                  e.push(n), d.push(m), g(h.get(n), m.get(n)), d.pop(), e.pop();
            else
              c.push(f() + "Expected to be an array, actually " + Kg(h) + ".");
          else if (m instanceof sb)
            if (h instanceof sb) {
              for (var p = ib(h, 1), q = {}, r = 0; r < p.length; r++)
                q[p[r]] = !0;
              ...
              for (var x = 0; x < p.length; x++)
                q[p[x]] &&
                  c.push(
                    f() + 'Unexpected property "' + p[x] + '" found in actual.'
                  );
              ...
              c.push(f() + "Expected to be an object, actually " + Kg(h) + ".");
  ...
  var Ch = function (a) {
    ...
    Vh = function (a, b) {
      a.some(function (c) {
        ...
        ? Promise.all(
            a.map(function (c) {
              return c.value && -1 !== Uh.indexOf(c.name)
    ...
    Wh = function (a) {
      ...
      function d(r, t) {
        ...
        var v = Th[t];
        r.hasOwnProperty(v) &&
          (r.hasOwnProperty(t) && O(90), (u = r[v]), c(u, !0));
        return u;
      }
      function e(r, t, u) {
        var v = d(r, t);
    ...
    Yh = function (a) {
      ...
      return { Nf: encodeURIComponent(b.join("~")), Lh: c };
    },
    $h = function (a) {
      if (z.Promise)
        try {
  ...
  qi.fa = "dataLayer";
  qi.mk =
    "ChAIgNfurAYQ7p6j163cjsVsEiQApxMCtCDNgU5xN3mNBLyz0GgitO9+YKzTYsEskIjHzPXCXtEaAhUt";
  var ti = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  try {
    qj = JSON.parse(
      yb(
        "eyIwIjoiSU4iLCIxIjoiSU4tVEciLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5jby5pbiIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"
      )
    );
  } catch (a) {
    O(123), pj(2), (qj = {});
  ...
  var Bj = !1,
    ...
    Ej = {},
    Fj = !1,
    Gj = { ad_storage: !1, ad_user_data: !1, ad_personalization: !1 };
  function Hj() {
  ...
  var Nj = function (a) {
    ...
    Vj = function (a, b) {
      function c() {
        for (var e = 0; e < b.length; e++) if (!Qj(b[e])) return !0;
        return !1;
      }
      if (c()) {
        var d = !1;
  ...
  var Zj = [Q.g.J, Q.g.R, Q.g.N, Q.g.Ea],
    ak = function (a) {
      for (
        var b = a[Q.g.Va], c = Array.isArray(b) ? b : [b], d = { De: 0 };
        d.De < c.length;
        d = { De: d.De }, ++d.De
      )
        l(
    ...
    dk = function (a) {
      for (
        var b = a[Q.g.Va], c = Array.isArray(b) ? b : [b], d = { Fe: 0 };
        d.Fe < c.length;
        d = { Fe: d.Fe }, ++d.Fe
      )
        l(
    ...
    ek = function (a) {
      for (
        var b = a[Q.g.Va], c = Array.isArray(b) ? b : [b], d = { kd: 0 };
        d.kd < c.length;
        d = { kd: d.kd }, ++d.kd
      )
  ...
  function Dk() {
    ...
    if (a.pending) {
      for (
        var b, c = [], d = !1, e = uk(), f = wk(), g = {}, h = 0;
        h < a.pending.length;
        g = { Pe: void 0 }, h++
      )
        (g.Pe = a.pending[h]),
          Ja(
            g.Pe.target.isDestination ? f : e,
            (function (m) {
              return function (n) {
  ...
  var Ek = function () {
      for (var a = nk(), b = uk(), c = 0; c < b.length; c++) {
        ...
        d
          ? ((d.state = 2), (d.containers = uk()), (d.destinations = wk()))
          : (a.container[b[c]] = {
              state: 2,
              containers: uk(),
              destinations: wk(),
      ...
      for (var e = wk(), f = 0; f < e.length; f++) {
        ...
        g && 0 === g.state && O(93);
        g
          ? ((g.state = 2), (g.containers = uk()), (g.destinations = wk()))
          : (a.destination[e[f]] = {
              state: 2,
              containers: uk(),
              destinations: wk(),
    ...
    Hk = function () {
      return { ctid: yk(), isDestination: qk.je };
    };
  function Ik(a) {
    var b = nk();
  ...
  var Mk = { sampleRate: "0.005000", hk: "", gk: Number("5"), Zn: Number("") },
    Nk = [];
  function Ok(a) {
    Nk.push(a);
  }
    ...
    hl = function (a, b, c) {
      ...
      try {
        ...
        if ("array" === d) {
          ...
          for (var e = 0; e < b.length; e++) if (hl(a, b[e], c[e])) return !0;
        } else {
        ...
        if (a.purpose && a.vendor) {
          ...
          m =
            n && "1" === b && a.purposeOneTreatment && "CH" === a.publisherCC
              ? !0
              : n && Xl(a.purpose.consents, b);
        } else m = !0;
      else
        m =
          1 === h
            ? a.purpose && a.vendor
              ? Xl(a.purpose.legitimateInterests, b) &&
                Xl(a.vendor.legitimateInterests, void 0 === d ? "755" : d)
              : !0
            : !0;
      return m;
    },
    ...
    $l = function (a) {
      ...
      return "error" === a.cmpStatus || 0 !== a.internalErrorState
        ? a.internalBlockOnErrors
          ? (Ql({ e: String(a.internalErrorState) }), !1)
          : !0
        : "loaded" !== a.cmpStatus ||
  ...
  var am = { 1: 0, 3: 0, 4: 0, 7: 3, 9: 3, 10: 3 },
    bm = xl("", 500);
  function cm() {
    var a = ri.tcf || {};
    return (ri.tcf = a);
        ...
        try {
          b.addEventListener(function (c) {
            if (0 !== c.internalErrorState)
              hm(a),
                S(53)
                  ? (kk([Q.g.J, Q.g.Ea, Q.g.N]), (Hj().active = !0))
                  : im(a);
            else {
          ...
          hm(a),
            S(53) ? (kk([Q.g.J, Q.g.Ea, Q.g.N]), (Hj().active = !0)) : im(a);
        }
      }
    };
  function hm(a) {
  ...
  function im(a) {
    ...
    if (S(53)) {
      ...
      "number" === typeof a.tcfPolicyVersion && 4 <= a.tcfPolicyVersion
        ? (c[Q.g.N] = a.Yb["1"] && a.Yb["7"] ? "granted" : "denied")
        : kk([Q.g.N]);
    }
    ck(
      c,
      { eventId: 0 },
      { gdprApplies: a ? a.gdprApplies : void 0, tcString: lm() || "" }
    );
  }
  var lm = function () {
      var a = cm();
  ...
  var tm = function (a) {
    ...
    wm = {},
    xm =
      ((wm[Q.g.J] = 0), (wm[Q.g.R] = 1), (wm[Q.g.N] = 2), (wm[Q.g.Ea] = 3), wm);
  function ym(a) {
    switch (a) {
      case void 0:
        return 1;
        ...
        for (var b = "1", c = 0; c < pm.length; c++) {
          ...
          b =
            ...
            ("" +
              ...
              "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[
                (ym(m.declare) << 4) | (ym(m.default) << 2) | ym(m.update)
              ]);
        }
        var n = b,
          p;
    ...
    Am = function () {
      ...
      if (b && d)
        for (var f in Ej)
          ...
          c.hasOwnProperty(f) &&
          c[f].enabled
            ? (e[f] = { enabled: !0, region: Ej[f].region })
            : (e[f] = { enabled: !1, region: Ej[f].region });
      else {
        var g = b ? Ej : c,
          h;
        for (h in g)
      ...
      for (
        var m = {}, n = ia(Object.keys(e)), p = n.next();
        !p.done;
        p = n.next()
      ) {
        var q = p.value;
      ...
      for (
        var r = "", t = ia(Object.keys(pi)), u = t.next();
        !u.done;
        u = t.next()
      ) {
        var v = u.value;
  ...
  function Km(a, b, c) {
    for (var d = [], e = Jm(a, void 0, void 0, c), f = 0; f < e.length; f++) {
      ...
      if (!b || -1 !== b.indexOf(h)) {
        ...
        m &&
          ((m = m.split("-")),
          d.push({ id: g.join("."), Gf: 1 * m[0] || 1, Oe: 1 * m[1] || 1 }));
      }
    }
    return d;
  }
  var Om = function (a) {
    ...
    Qm = function (a, b) {
      return (
        Um.test(window.document.location.hostname) || ("/" === b && Tm.test(a))
      );
    },
    Im = function () {
  ...
  var cn = { UA: 1, AW: 2, DC: 3, G: 4, GF: 5, GT: 12, GTM: 14, HA: 6, MC: 7 },
    dn = function (a, b) {
  ...
  var An,
    ...
    En = function (a, b) {
      a &&
        ((b.h[Q.g.Xd] = a.architecture),
        (b.h[Q.g.Yd] = a.bitness),
        a.fullVersionList &&
          (b.h[Q.g.Zd] = a.fullVersionList
            .map(function (c) {
              return (
  ...
  function lo(a, b, c) {
    "a" === c.tagName.toLowerCase()
      ? ko(a, b, c)
      : "form" === c.tagName.toLowerCase() && jo(a, b, c);
  }
  ...
  function zo(a, b) {
    var c = b.split(".");
    5 === c.length
      ? ((ro[a] = c.slice(0, 2).join(".")),
        (so[a] = { id: c.slice(2, 4).join("."), Bh: Number(c[4]) || 0 }))
      : 3 === c.length
      ? (so[a] = { id: c.slice(0, 2).join("."), Bh: Number(c[2]) || 0 })
      : (ro[a] = b);
  }
  function to(a) {
    return (a || "_gcl") + "_au";
  ...
  var Fo = /^\w+$/,
    Go = /^[\w-]+$/,
    Ho = { aw: "_aw", dc: "_dc", gf: "_gf", ha: "_ha", gp: "_gp", gb: "_gb" };
  function Io() {
    return Sf(14) ? ["ad_storage", "ad_user_data"] : ["ad_storage"];
  }
  var Jo = function () {
          ...
          if (void 0 !== Ho[f]) {
            ...
            if (h) {
              ...
              b: {
                ...
                if (Fm(z))
                  for (
                    var q = Jm(g, E.cookie, void 0, Io()), r = 0;
                    r < q.length;
                    ++r
                  )
                    if (Wo(q[r]) > p) {
      ...
      var b = function () {
        function c(y) {
          ...
          if (!D[F]) {
            ...
            J("gclsrc", q);
            if (
              !(I.gclid || I.dclid || I.gclaw) &&
              (J("gbraid", jp(e, t)), !I.gbraid && Rj() && fk(Q.g.J))
            ) {
              var aa = Mo("_gcl_gb");
            ...
            if (V) {
              var T = function (ea, ca) {
                G.push(ea + "=" + encodeURIComponent(ca));
                I[ea] = !0;
              };
              ...
              V.fullVersionList &&
                T(
                  ...
                  V.fullVersionList
                    .map(function (ea) {
                      return (
                        encodeURIComponent(ea.brand || "") +
                        ";" +
                        encodeURIComponent(ea.version || "")
                      );
                    })
                    .join("|")
                );
        ...
        for (
          ...
          zp[g.id] ||
            (g && "AW" === g.prefix && !e.adData && 2 <= g.P.length
              ? ((e.adData = { ak: g.P[0], cl: g.P[1] }),
                S(115) &&
                  ((e.adData.dma = Cm()), Dm() && (e.adData.dmaCps = Am())),
                (zp[g.id] = !0))
              : g &&
                "UA" === g.prefix &&
                !e.gaData &&
                ((e.gaData = { gaWpid: g.da }), (zp[g.id] = !0)));
        }
          ...
          if (!d || e) {
            ...
            if (m) {
              ...
              for (var w = 0; w < n.length; w++)
                if (w < v)
                  if (d) Bp(d, n[w], t, { Fb: u, options: r });
                  else if ("AW" === a.prefix && a.P[1])
                    Cp()
                      ? Bp([a], n[w], t || "US", { Fb: u, options: r })
                      : Ap(a.P[0], a.P[1], n[w], { Fb: u, options: r });
                  else if ("UA" === a.prefix)
                    if (Cp()) Bp([a], n[w], t || "US", { Fb: u });
                    else {
                      var x = a.da,
                        y = n[w],
                        A = { Fb: u };
  ...
  var $p = { initialized: 11, complete: 12, interactive: 13 },
    aq = {},
  ...
  var vq = function (a, b, c) {
    ...
    Iq = function (a, b, c) {
      ...
      !f ||
        ...
        e.push({ aa: f, ze: h });
      g && e.push({ aa: g, ze: "ds" });
      0 === e.length && d.gbraid && e.push({ aa: d.gbraid, ze: "gb" });
      0 === e.length && "aw.ds" === h && e.push({ aa: "", ze: "aw.ds" });
      Bq(function () {
        if ((S(52) && S(57)) || fk(Q.g.J)) {
          ...
          if (0 !== e.length || m || void 0 !== n) {
            ...
            if (S(84)) {
              ...
              r.push("gcd=" + zm(A));
              S(30) &&
                (Dm() && r.push("dma_cps=" + Am()), r.push("dma=" + Cm()));
    ...
    Jq = function (a) {
      return On("gclaw") || On("gac") || 0 < (So().aw || []).length
        ? !1
        : 0 < (So().gb || []).length
        ? !0
        : hp(a);
  ...
  var Nq = function (a, b) {
      ...
      a.vj &&
        (po(c[Q.g.qc], !!c[Q.g.X]) && (Xo(Mq, b), Bo(b)),
        Uo(b),
        $o(Mq, b),
        Iq(b, e, f));
      c[Q.g.X] &&
        (Zo(Mq, c[Q.g.X], c[Q.g.Nb], !!c[Q.g.zb], b.prefix),
        Co(to(b.prefix), c[Q.g.X], c[Q.g.Nb], !!c[Q.g.zb], b),
        Co("FPAU", c[Q.g.X], c[Q.g.Nb], !!c[Q.g.zb], b));
      d && bp(Mq);
      dp(Mq);
    },
    Oq = function (a, b, c, d) {
      ...
      if ("function" === typeof f)
        ...
        } else e === Q.g.Ib ? (O(65), xo(b, !1), f(ro[to(b.prefix)])) : f(g);
    },
    Mq = ["aw", "dc", "gb"];
  function Pq(a) {
    var b = W(a.o, Q.g.yb),
      c = W(a.o, Q.g.Mb);
    b && !c
      ? (a.eventName !== Q.g.sa && a.eventName !== Q.g.yd && O(131),
        (a.isAborted = !0))
  ...
  var Sq = /^(www\.)?google(\.com?)?(\.[a-z]{2}t?)?$/,
    ...
    Vq = function (a) {
      ...
      return a.qn
        ? !1
        : a.Zl || a.am || a.bm || a.rh || a.If || a.Kl || a.Rl
        ? !0
        : !1;
    },
    Uq = function () {
  ...
  var gr = function (a, b, c) {
    ...
    hr = function (a, b, c) {
      return gr({ element: a.element, W: a.W, ma: "1" }, b, c);
    },
    ir = function (a) {
      var b = !!a.md + "." + !!a.nd;
      ...
      a &&
        a.ob &&
        (b += "." + a.ob.email + "." + a.ob.phone + "." + a.ob.address);
      return b;
    },
    lr = function (a) {
      if (0 != a.length) {
  ...
  var nr = /[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}/i,
    ...
    qr = ["BR"],
    vr = { vn: "1", Kn: "2", zn: "3", Dn: "4", sn: "5", Ln: "6", Gn: "7" },
    wr = {},
    rr = ["INPUT", "SELECT"];
  var Pr = function (a) {
      a = a || { md: !0, nd: !0 };
      ...
      g && (h = hr(g, a.md, a.nd));
      var D = { elements: m, Mh: h, status: e };
      wr[b] = { timestamp: Ua(), result: D };
      return D;
    },
    Qr = function (a) {
      return (
        a.tagName + ":" + a.isVisible + ":" + a.W.length + ":" + ur.test(a.W)
      );
    };
  var Rr = {
    jl: Number("") || 500,
  ...
  function Es(a, b) {
    if (zs.test(E.location.host)) {
      ...
      return c && 2 == c.length && c[1].match(xs)
  ...
  var Fs = function (a, b, c) {
    ...
    return { Jl: f ? e.join(";") : "", Il: Es(d, Bs) };
  };
  function Gs(a, b, c) {
    if (zs.test(E.location.host)) {
      var d = E.location.href.match(c);
      if (d && 2 == d.length && d[1].match(ys)) return [{ aa: d[1] }];
  ...
  var Ls = function () {
    ...
    Rs = function (a) {
      if (
        Ps(a, ["conversion", "remarketing", "user_data_lead", "user_data_web"])
      ) {
        var b = a.h[Q.g.jb],
          c = !0 === W(a.o, Q.g.Ze);
        ...
        a.h[Q.g.Yi] = a.metadata.is_gcp_conversion
          ? "www.google.com"
    ...
    Us = function (a) {
      Ps(a, ["conversion", "remarketing"]) &&
        ...
        (S(52) && !fk(Q.g.N)) || a.copyToHitData(Q.g.Ta));
    },
    Vs = function (a) {
      if (!yn(z)) O(87);
      else if (void 0 !== An) {
        ...
        if ($i(b)) {
          ...
          null === c
            ...
            : (b.enable_code && nb(c) && (a.metadata.user_data_from_code = c),
              nb(b.selectors) &&
                (a.metadata.user_data_from_manual = Zi(b.selectors)));
        }
      }
    },
    bt = function (a) {
    ...
    dt = function (a) {
      if (
        !(a.eventName !== Q.g.sa || (S(99) && a.metadata.consent_updated)) &&
        ((a.metadata.is_config_command = !0),
        Ps(a, "conversion") && (a.metadata.speculative = !0),
        !Ps(a, "remarketing") ||
          (!1 !== W(a.o, Q.g.Jb) && !1 !== W(a.o, Q.g.Sa)) ||
        ...
        Nq({ vj: d, Ij: b, bk: c, Tf: e, allowAdPersonalizationSignals: f }, g);
        Dp(a.target, a.o);
        mp({
          eh: !1,
    ...
    ft = function (a) {
      if (a.eventName === Q.g.Pa && !a.o.isGtmEvent) {
        if (!a.metadata.consent_updated && Ps(a, "conversion")) {
          var b = W(a.o, Q.g.wb);
      ...
      if (Ps(a, ["conversion", "remarketing"])) {
        ...
        (b && a.eventName !== Q.g.ra) ||
          ...
          b &&
            ...
            a.copyToHitData(Q.g.Ad),
            (a.h[Q.g.hg] = a.eventName)));
      }
    },
    jt = function (a) {
      if (
    ...
    pt = function (a) {
      Ps(a, ["conversion"]) &&
        (a.metadata.redact_click_ids =
          !!a.metadata.redact_ads_data && !fk(Ls()));
    },
    qt = function (a) {
      if (
        Ps(a, ["conversion", "user_data_lead", "user_data_web"]) &&
        fk(Q.g.J) &&
        ...
        if (!S(52) || fk(Q.g.N)) {
          var d = c;
          if (
            zs.test(E.location.host)
              ? Cs.test(E.location.href) || As.test(E.location.href)
              : !hp(d)
          ) {
            var e = Hs(c);
            e && (a.h[Q.g.tb] = e);
    ...
    rt = function (a) {
      if (
        ...
        if ("remarketing" !== a.metadata.hit_type || b) {
          ...
          if (!S(52) || fk(Q.g.N)) a.h[Q.g.Ib] = ro[to(c.prefix)];
        }
      }
    },
    st = function (a) {
    ...
    ut = function (a) {
      ...
      switch (a.metadata.hit_type) {
        ...
        case "remarketing":
          ...
          break;
        case "conversion":
          a.metadata.consent_updated && (a.h[Q.g.ud] = !0);
      }
    },
    vt = function (a) {
      Ps(a, ["conversion"]) &&
  ...
  var tu = function (a) {
    ...
    yu = function (a) {
      ...
      for (var b = [], c = 0; c < a.length; c++) {
        ...
        d &&
          (e.push(xu(d.value)),
          e.push(xu(d.quantity)),
          e.push(xu(d.item_id)),
          e.push(xu(d.start_date)),
          e.push(xu(d.end_date)),
          b.push("(" + e.join("*") + ")"));
      }
    ...
    Du = function (a, b) {
      ...
      switch (c) {
        case "conversion":
          ...
          if (!S(52) || fk(Q.g.N)) t.attributes = { attributionsrc: "" };
          q(t);
        ...
        case "user_data_lead":
          q({
            Ia: "https://google.com/pagead/form-data/" + d + "?" + Cu(a, b),
            format: 1,
            Da: !0,
          });
          break;
      ...
      bn() ||
        ...
        !a.metadata.send_fledge_experiment ||
        q({ Ia: ws() + "/td/rul/" + d + "?" + Cu(a, b), format: 4, Da: !1 });
      return { onSuccess: h, dm: f };
    },
    ...
    Iu = function (a) {
      Hu(a, function (b, c) {
        for (
          var d = Du(a, b), e = d.onSuccess, f = d.dm, g = {}, h = 0;
          h < f.length;
          g = { Ia: void 0, mh: void 0, Da: void 0, Xg: void 0 }, h++
        ) {
          var m = f[h];
          g.Ia = m.Ia;
          g.mh = m.format;
  ...
  var Ou = function (a, b, c) {
    ...
    Mu = function (a, b, c, d) {
      ...
      Zh(b, function (g, h) {
        ...
        um() && Ku(f, "gcs", vm());
        (Rj() || S(28)) && Ku(f, "gcd", zm());
        S(30) && (Dm() && Ku(f, "dma_cps", Am()), Ku(f, "dma", Cm()));
      ...
      if (!cv() && !Fk(a)) {
        ...
        if (!n) {
          ...
          h &&
            Dc &&
            g &&
            (p = Dc.replace(/^(?:https?:\/\/)?/i, "").split(/[?#]/)[0]);
          n = sp("https://", "http://", p + f);
        }
        var q = a;
        d.siloed && (Ik({ ctid: q, isDestination: !1 }), (q = tk(q)));
        var r = q,
          t = Hk();
        nk().container[r] = { state: 1, context: d, parent: t };
        ok({ ctid: r, isDestination: !1 }, e);
        Kc(n);
      }
    },
    ev = function (a, b, c, d) {
      if (!cv() && !Gk(a))
        if (Jk())
          ...
          var g = a;
          c.siloed && (Ik({ ctid: g, isDestination: !0 }), (g = tk(g)));
          nk().destination[g] = { state: 1, context: c, parent: Hk() };
          ok({ ctid: g, isDestination: !0 }, d);
          Kc(f);
        }
    };
  function cv() {
  ...
  function Wv(a, b, c, d) {
    ...
    if (n && n.length) {
      var p = n[0],
        q = Vv(p.index, { onSuccess: g, onFailure: h, terminate: m }, c, d);
      if (!q) return null;
      g = q;
      h = 2 === p.Aj ? m : q;
    }
  ...
  var Tw = function (a, b) {
    for (var c = [], d = 0; d < of.length; d++)
      if (a[d]) {
        ...
        var f = sv(b.Wb);
        try {
          var g = Vv(d, { onSuccess: f, onFailure: f, terminate: f }, b, d);
          if (g) {
            var h = e[Oe.na];
  ...
  function Yw(a, b) {
    ...
    return S(105)
      ? function (d) {
          ...
          e = e.replace(/^_*/, "");
          for (
            var f = Su(), g = Ji[e] || [], h = ia(f), m = h.next();
            !m.done;
            m = h.next()
          ) {
            var n = m.value;
      ...
      consent: function (a, b) {
        if (3 === a.length) {
          ...
          "default" === d
            ...
            ? ck(e, c)
            : "declare" === d
            ? b.fromContainerExecution && ak(e)
            : S(72) && "core_platform_services" === d && dk(e);
        }
      },
      event: function (a, b) {
        var c = a[1];
        if (!(2 > a.length) && k(c)) {
          ...
          var q = d,
            r = q && q[Q.g.Pb];
          void 0 === r &&
            ((r = Si(Q.g.Pb, 2)), void 0 === r && (r = "default"));
          if (k(r) || Ia(r)) {
            var t;
            b.isGtmEvent
              ? (t = k(r) ? [r] : r)
            ...
            for (var D = [], F = 0; F < C.length; F++) {
              ...
              if (-1 !== ix.indexOf(Bk(G.prefix))) {
                ...
                P.hasOwnProperty("is_external_event") ||
                  (P.is_external_event = !I.fromContainerExecution);
                I.eventMetadata = P;
                delete J[Q.g.Xc];
                lq(c, J, G.id, I);
              }
  ...
  function Zx(a, b) {
    ...
    if (!a.event) return !1;
    "number" !== typeof d &&
      ((d = Li()), (a["gtm.uniqueEventId"] = d), Vi("gtm.uniqueEventId", d));
    return cx(a);
  }
  function $x(a) {
  ...
  function QA(a, b, c) {
        ...
        if (S(107)) {
          ...
          w =
            (null == (x = Qu(zk()))
              ...
              ? void 0
              : y.external) || [];
          for (var A = ia(w), C = A.next(); !C.done; C = A.next())
            Ru(v, C.value, !0);
          var D, F, G;
          D =
            (null == (F = Qu(zk()))
              ...
              ? void 0
              : G.external) || [];
          for (var I = ia(D), J = I.next(); !J.done; J = I.next())
            Tu(v, J.value, !0);
        }
        m && m(new PA(a, v));
      },
    ...
    var t = { source: r, fromContainerExecution: !0, siloed: q };
    if (n) ev(a, h, t, e);
    else {
  ...
  function uB(a) {
    return a ? { originatingEntity: tB(a) } : {};
  }
  function vB(a) {}
  ...
  var VC = function (a, b) {
      ...
      b
        ...
        : ((c = [Pq, $s, Qs, ct, Rs, Ss, Ts, Us, ht, it, kt, mt]),
          S(109) && c.push(Qq),
          S(99) || c.push(dt, jt),
          (c = c.concat([vt, wt])));
    ...
    XC = function (a, b, c, d) {
      function e() {
        for (var r = 0; r < g.length; r++) {
          var t = g[r];
          t.isAborted ||
            (VC(g[r], !0), t.metadata.speculative || t.isAborted || Iu(t));
        }
      }
      ...
      if (f) {
        ...
        if (d.eventMetadata.hit_type_override) {
          ...
          b === Q.g.sa && g.push(WC("landing_page", f, b, d)),
            g.push(WC("conversion", f, b, d)),
            g.push(WC("user_data_lead", f, b, d)),
            g.push(WC("user_data_web", f, b, d)),
            g.push(WC("remarketing", f, b, d));
  ...
  var eG = window,
    ...
    gG = function (a) {
      ...
      if (
        (b && b.ioo && b.ioo()) ||
        fG.documentElement.hasAttribute("data-google-analytics-opt-out") ||
        (a && !0 === eG["ga-disable-" + a])
      )
        return !0;
      try {
      ...
      for (
        var d = Gm("AMP_TOKEN", String(fG.cookie), !0), e = 0;
        e < d.length;
        e++
      )
  ...
  var KG = {};
  function MG(a, b, c, d) {}
  var NG = Object.freeze({ dl: 1, id: 1 }),
    OG = {};
  function PG(a, b, c, d) {}
  MG.O = "injectScript";
    ...
    (function () {
      ...
      (function (b) {
        ...
        if (!b.vtp_enableCrossDomain || !1 !== b.vtp_acceptIncoming)
          if (b.vtp_enableCrossDomain || oo()) Xo(a, g), Bo(g);
        Uo(g);
        $o(["aw", "dc"], g);
        Iq(g);
      ...
      (function (f) {
        ...
        if (k(g) && 0 === g.indexOf("G-")) {
          ...
          f.vtp_sendEcommerceData &&
            (fi.hasOwnProperty(h) || "checkout_option" === h) &&
            b(f, h, m);
          ...
          var t = QH(f.vtp_eventParameters, "name", "value"),
            u;
      ...
      (function (a) {
        ...
        "DATA_LAYER" == a.vtp_customParamsFormat
          ...
          : "USER_SPECIFIED" == a.vtp_customParamsFormat &&
            (c = QH(a.vtp_customParams, "key", "value"));
        b = nb(c) ? c : {};
        b[Q.g.Ze] = !0;
        var d =
        ...
        a.vtp_enableDynamicRemarketing &&
          (a.vtp_eventValue && (b[Q.g.ia] = a.vtp_eventValue),
          a.vtp_eventItems && (b[Q.g.Z] = a.vtp_eventItems));
        ...
        if (S(37)) {
          ev(e, void 0, { source: 7, fromContainerExecution: !0, siloed: !0 });
          var g = {},
            h = {
          ...
          var m = wl(
            vl(
              ul(
                tl(
                  ml(new ll(a.vtp_gtmEventId, a.vtp_gtmPriorityId), b),
                  a.vtp_gtmOnSuccess
                ),
                a.vtp_gtmOnFailure
              ),
      ...
      function b(d) {
        if (E.body) {
          ...
          if (d.vtp_useIframe) {
            ...
            d.vtp_supportDocumentWrite ? c(g, h, e) : a(E.body, Sc(g), h, e)();
        } else
          mz(function () {
            b(d);
          }, 200);
  ...
  (function (a) {
      ...
      var f = function (u) {
          ...
          var y = {
            ...
            data: {
              ...
              debug: !1,
              id: Tf.ctid,
              targetRef: { ctid: Tf.ctid, isDestination: qk.je },
              aliases: sk(),
              destinations: vk(),
            },
          };
    ...
    try {
      ...
      if (nk().canonical[a]) {
        ...
        MH(x);
        if (void 0 !== y) for (var T = 0; T < y.length; T++) Ki[y[T]] = !0;
        mJ();
        if (S(26) && !Di) {
          for (
            var ja = qj["7"], ea = ja ? ja.split("|") : [], ca = {}, Da = 0;
            Da < ea.length;
            Da++
          )
            ca[ea[Da]] = !0;
