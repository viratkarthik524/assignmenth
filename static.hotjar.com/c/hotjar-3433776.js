...
!(function () {
  ...
  var s,
    ...
    c = {
      version: 6,
      metricsUrl:
        (null === (t = window._hjSettings) || void 0 === t
          ? void 0
          : t.metricsUrl) || "https://metrics.hotjar.io",
      sampling: {
        metrics: 0.1,
        fieldMetrics: 0.01,
        debug: 0.5,
    ...
    g = function (e) {
      var t = !1,
        ...
        n = u.isDebugEnabled
          ? "".concat(c.metricsUrl, "?").concat(r, "&debug=true")
          : "".concat(c.metricsUrl, "?").concat(r),
        i = JSON.stringify(e);
    ...
    b = {
      ...
      start: function () {
        try {
          ...
          return (
            ...
            (s = new r(g, c.buffer.bufferSize, c.buffer.flushInterval)),
            e
          );
        } catch (e) {
      ...
      timeIncr: function (e, t) {
        ...
        return (
          ...
          c && b.timeEnd(e, { tag: s, total: w, extraTags: d, type: h }),
          w
        );
      },
  ...
  (window.hjBootstrap =
    ...
    (window.hjLazyModules = window.hjLazyModules || {
      SURVEY_V2: { js: "survey-v2.d5405e3bb2d866a8d81e.js" },
      SURVEY_BOOTSTRAPPER: {
        js: "survey-bootstrapper.d55717dad3e3dcd9f312.js",
      },
      SURVEY_ISOLATED: { js: "survey-isolated.deb18d17784ac2d97d3b.js" },
      HEATMAP_RETAKER: { js: "heatmap-retaker.03eedc48703630f6a41e.js" },
      SURVEY_INVITATION: { js: "survey-invitation.0eed63f2449b5c5cd14a.js" },
      NOTIFICATION: { js: "notification.0ed6d753395a17d0055b.js" },
      INCOMING_FEEDBACK: { js: "incoming-feedback.90d38ed80bddf873aec3.js" },
      PREACT_INCOMING_FEEDBACK: {
        js: "preact-incoming-feedback.8917ef65a56484395694.js",
      },
      SENTRY: { js: "sentry.58c81e3e25532810f6fd.js" },
      BROWSER_PERF: { js: "browser-perf.28a8c6b22b3c0474c577.js" },
    });
})();
