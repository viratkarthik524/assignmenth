    ...
    24468: function (t, e, i) {
      ...
      class y {
        ...
        buildOrUpdateElements(t) {
          ...
          (e._stacked = g(e.vScale, e)),
            e.stack !== i.stack && ((s = !0), _(e), (e.stack = i.stack)),
          ...
          for (let y = 0; y < b; ++y) {
            ...
            const b = this.getParsed(y),
              ...
              M = (p[g] =
                o || w
                  ? r.getBasePixel()
                  : r.getPixelForValue(h ? this.applyStack(r, b, h) : b[g], y));
            (p.skip = isNaN(k) || isNaN(M) || w),
              (p.stop = y > 0 && Math.abs(b[u] - v[u]) > m),
              f && ((p.parsed = b), (p.raw = l.data[y])),
              d &&
                (p.options =
                  c ||
                  this.resolveDataElementOptions(y, i.active ? "active" : n)),
              x || this.updateElement(i, y, p, n),
              (v = b);
          }
        }
        getMaxOverflow() {
      ...
      var P = {
        ...
        modes: {
          ...
          point: (t, e, i, n) =>
            S(t, (0, s.z)(e, t), i.axis || "xy", n, i.includeInvisible || !1),
          nearest(t, e, i, n) {
            const o = (0, s.z)(e, t),
              a = i.axis || "xy",
              r = i.includeInvisible || !1;
      ...
      function B(t, e, i, s) {
        ...
        for (o = 0, a = t.length, l = 0; o < a; ++o) {
          (r = t[o]),
            (h = r.box),
            h.update(r.width || e.w, r.height || e.h, H(r.horizontal, e));
          const { same: a, other: d } = R(e, i, r, s);
        ...
        for (const h of t) {
          ...
          if (h.horizontal) {
            ...
            (0, s.h)(l.start) && (r = l.start),
              t.fullSize
                ? W(t, o.left, r, i.outerWidth - o.right - o.left, a)
                : W(t, e.left + l.placed, r, n, a),
              (l.start = r),
              (l.placed += n),
              (r = t.bottom);
          } else {
            ...
            (0, s.h)(l.start) && (a = l.start),
              t.fullSize
                ? W(t, a, o.top, r, i.outerHeight - o.bottom - o.top)
                : W(t, a, e.top + l.placed, r, n),
              (l.start = a),
              (l.placed += n),
              (a = t.right);
          }
      ...
      var j = {
        ...
        update(t, e, i, n) {
          ...
          B(h.fullSize, p, u, f),
            ...
            V(h.leftAndTop, p, u, f),
            (p.x += p.w),
            (p.y += p.h),
            V(h.rightAndBottom, p, u, f),
            (t.chartArea = {
              left: p.left,
              top: p.top,
              right: p.left + p.w,
      ...
      function q(t, e, i) {
        const s = t.canvas,
          n = new MutationObserver((t) => {
            let e = !1;
            for (const i of t)
              (e = e || K(i.addedNodes, s)), (e = e && !K(i.removedNodes, s));
            e && i();
          });
      ...
      function G(t, e, i) {
        const s = t.canvas,
          n = new MutationObserver((t) => {
            let e = !1;
            for (const i of t)
              (e = e || K(i.removedNodes, s)), (e = e && !K(i.addedNodes, s));
            e && i();
          });
        return n.observe(document, { childList: !0, subtree: !0 }), n;
      }
      ...
      class nt extends $ {
        ...
        addEventListener(t, e, i) {
          ...
          const s = t.$proxies || (t.$proxies = {}),
            n = { attach: q, detach: G, resize: et }[e] || st;
          s[e] = n(t, e, i);
        }
        removeEventListener(t, e) {
          const i = t.$proxies || (t.$proxies = {}),
            s = i[e];
          if (!s) return;
          (({ attach: it, detach: it, resize: it }[e] || X)(t, e, s),
            (i[e] = void 0));
        }
        getDevicePixelRatio() {
      ...
      function at(t, e) {
        ...
        if (r > 0) {
          ...
          for (
            rt(e, c, d, (0, s.k)(n) ? 0 : h - n, h), t = 0, i = r - 1;
            t < i;
            t++
          )
            rt(e, c, d, a[t], a[t + 1]);
      ...
      class ft extends ot {
        ...
        update(t, e, i) {
          ...
          this._convertTicksToLabels(h ? ct(this.ticks, r) : this.ticks),
            this.configure(),
          ...
          (a = t.offset ? this.maxWidth / i : g / (i - 1)),
            d + 6 > a &&
              ...
              (r =
                ...
                ut(t.grid) -
                e.padding -
                gt(t.title, this.chart.options.font)),
              (h = Math.sqrt(d * d + u * u)),
              (l = (0, s.U)(
                Math.min(
                  Math.asin((0, s.S)((c.highest.height + 6) / a, -1, 1)),
                  Math.asin((0, s.S)(r / h, -1, 1)) -
                    Math.asin((0, s.S)(u / h, -1, 1))
                )
              )),
        ...
        fit() {
          ...
          if (a) {
            ...
            if (
              (r
                ? ((t.width = this.maxWidth), (t.height = ut(o) + a))
                : ((t.height = this.maxHeight), (t.width = ut(o) + a)),
          ...
          const {
            ...
            if (t.isHorizontal()) {
              if (((g = (0, s.a2)(n, a, h)), (0, s.i)(i))) {
                ...
                p =
                  "center" === i ? (c.bottom + c.top) / 2 + m - e : ht(t, i, e);
              u = h - a;
            } else {
              if ((0, s.i)(i)) {
                const t = Object.keys(i)[0],
                ...
                g =
                  "center" === i ? (c.left + c.right) / 2 - x + e : ht(t, i, e);
      ...
      class mt {
        ...
        unregister(t) {
          ...
          i in e && delete e[i],
            n &&
              i in s.d[n] &&
              (delete s.d[n][i], this.override && delete s.a3[i]);
        }
      }
      class xt {
        constructor() {
          (this.controllers = new mt(y, "datasets", !0)),
            (this.elements = new mt(ot, "elements")),
            (this.plugins = new mt(Object, "plugins")),
            (this.scales = new mt(ft, "scales")),
            ...
            ? (function (t, { plugins: e, localIds: i }, s, n) {
                ...
                for (const r of e) {
                  ...
                  null !== h &&
                    o.push({
                      plugin: r,
                      options: yt(t.config, { plugin: r, local: i[e] }, h, a),
                    });
                }
                return o;
              })(t, o, n, e)
      ...
      function yt(t, { plugin: e, local: i }, s, n) {
      ...
      class Lt {
        ...
        getOptionScopes(t, e, i) {
          ...
          const h = new Set();
          e.forEach((e) => {
            t && (h.add(t), e.forEach((e) => It(h, t, e))),
              e.forEach((t) => It(h, n, t)),
              e.forEach((t) => It(h, s.a3[o] || {}, t)),
              e.forEach((t) => It(h, s.d, t)),
              e.forEach((t) => It(h, s.a6, t));
          });
        ...
        resolveNamedOptions(t, e, i, n = [""]) {
          const o = { $shared: !0 },
            { resolver: a, subPrefixes: r } = Tt(this._resolverCache, t, n);
          let h = a;
          if (
            (function (t, e) {
        ...
        createResolver(t, e, i = [""], n) {
          const { resolver: o } = Tt(this._resolverCache, t, i);
      ...
      function Rt(t, e) {
        return (
          "top" === t || "bottom" === t || (-1 === Ft.indexOf(t) && "x" === e)
        );
      }
      function Ht(t, e) {
        return function (i, s) {
      ...
      class Yt {
        ...
        constructor(t, e) {
          ...
          (this.id = (0, s.ac)()),
            ...
            (jt[this.id] = this),
            h && l
              ? (o.listen(this, "complete", Bt),
                o.listen(this, "progress", Wt),
                this._initialize(),
        ...
        buildOrUpdateScales() {
          ...
          e &&
            ...
            (0, s.F)(o, (e) => {
              ...
              (void 0 !== o.position &&
                Rt(o.position, r) === Rt(e.dposition)) ||
        ...
        buildOrUpdateControllers() {
          ...
          for (
            ...
            if (
              ...
              (o.type = a),
              (o.indexAxis = n.indexAxis || wt(a, this.options)),
              (o.order = n.order || 0),
              (o.index = i),
              (o.label = "" + n.label),
        ...
        _getUniformDataChanges() {
          ...
          const e = this.data.datasets.length,
            ...
            n = i(0);
          for (let o = 1; o < e; o++) if (!(0, s.ag)(n, i(o))) return;
          return Array.from(n)
            .map((t) => t.split(","))
      ...
      function Gt(t, e, i, n) {
        const { points: o, options: a } = e,
          { count: r, start: h, loop: l, ilen: c } = qt(o, i, n),
          d = (function (t) {
            return t.stepped
              ? s.ar
      ...
      function Jt(t, e, i, s) {
        const n = e.points,
          { count: o, start: a, ilen: r } = qt(n, i, s),
      ...
      class ie extends ot {
        ...
        draw(t, e, i, s) {
          ...
          (this.points || []).length &&
            n.borderWidth &&
            (t.save(), ee(t, this, i, s), t.restore()),
            this.animated &&
      ...
      class ae extends ot {
        ...
        fit() {
          ...
          const i = t.labels,
            ...
            { boxWidth: r, itemHeight: h } = oe(i, o);
          let l, c;
          (e.font = n.string),
            this.isHorizontal()
        ...
        _fitCols(t, e, i, s) {
          ...
          return (
            this.legendItems.forEach((t, o) => {
              const { itemWidth: f, itemHeight: m } = (function (
                t,
                e,
                i,
                s,
        ...
        _draw() {
          ...
          this.drawTitle(),
            ...
            (n.lineWidth = 0.5),
            (n.font = l.string);
          const { boxWidth: p, boxHeight: f, itemHeight: m } = oe(a, d),
            x = this.isHorizontal(),
          ...
          this.legendItems.forEach((v, y) => {
            ...
            h.setWidth(this.width),
              x
                ? y > 0 &&
                  ...
                  g.line++,
                  (S = g.x =
                    (0, s.a2)(o, this.left + c, this.right - i[g.line])))
                : y > 0 &&
                  D + b > this.bottom &&
            ...
            if (
              ...
              (S = (0, s.aB)(k, S + p + u, x ? S + M : this.right, t.rtl)),
              (function (t, e, i) {
        ...
        _getLegendItemAt(t, e) {
          ...
          if (
            ...
            for (o = this.legendHitBoxes, i = 0; i < o.length; ++i)
              if (
                ((n = o[i]),
                (0, s.aj)(t, n.left, n.left + n.width) &&
                  (0, s.aj)(e, n.top, n.top + n.height))
              )
      ...
      var he = {
        ...
        _element: ae,
        start(t, e, i) {
          const s = (t.legend = new ae({ ctx: t.ctx, options: i, chart: t }));
      ...
      var ce = {
        ...
        start(t, e, i) {
          !(function (t, e) {
            const i = new le({ ctx: t.ctx, options: e, chart: t });
      ...
      function xe(t, e, i) {
        ...
        return { xAlign: i.xAlign || e.xAlign || me(t, e, i, s), yAlign: s };
      }
      function _e(t, e, i, n) {
      ...
      class Me extends ot {
        ...
        getTitle(t, e) {
          const { callbacks: i } = e,
            s = ke(i, "beforeTitle", this, t),
            n = ke(i, "title", this, t),
            o = ke(i, "afterTitle", this, t);
          let a = [];
          ...
          return (
            (0, s.F)(t, (t) => {
              const e = { before: [], lines: [], after: [] },
                s = ye(i, t);
              ue(e.before, ge(ke(s, "beforeLabel", this, t))),
                ue(e.lines, ke(s, "label", this, t)),
                ue(e.after, ge(ke(s, "afterLabel", this, t))),
                n.push(e);
            }),
            n
          );
        ...
        getFooter(t, e) {
          const { callbacks: i } = e,
            s = ke(i, "beforeFooter", this, t),
            n = ke(i, "footer", this, t),
            o = ke(i, "afterFooter", this, t);
          let a = [];
          return (a = ue(a, ge(s))), (a = ue(a, ge(n))), (a = ue(a, ge(o))), a;
        }
        _createItems(t) {
          ...
          return (
            ...
            (0, s.F)(l, (e) => {
              ...
              n.push(ke(i, "labelColor", this, e)),
                o.push(ke(i, "labelPointStyle", this, e)),
                a.push(ke(i, "labelTextColor", this, e));
            }),
            (this.labelColors = n),
        ...
        getCaretPosition(t, e, i) {
          ...
          return (
            "center" === o
              ? ((v = g + f / 2),
                "left" === n
                  ? ((m = u), (x = m - a), (b = v + a), (y = v - a))
                  : ((m = u + p), (x = m + a), (b = v - a), (y = v + a)),
                (_ = m))
              : ((x =
                  "left" === n
                    ? u + Math.max(h, c) + a
                    ...
                    : this.caretX),
                "top" === o
                  ? ((b = g), (v = b - a), (m = x - a), (_ = x + a))
                  : ((b = g + f), (v = b + a), (m = x + a), (_ = x - a)),
                (y = b)),
            { x1: m, x2: x, x3: _, y1: b, y2: v, y3: y }
          );
        }
        drawTitle(t, e, i) {
          const n = this.title,
        ...
        _drawColorBox(t, e, i, n, o) {
          ...
          if (o.usePointStyle) {
            ...
            Object.values(r).some((t) => 0 !== t)
              ? (t.beginPath(),
                (t.fillStyle = o.multiKeyBackground),
                (0, s.au)(t, { x: e, y: p, w: l, h: h, radius: r }),
                t.fill(),
                t.stroke(),
                (t.fillStyle = a.backgroundColor),
                t.beginPath(),
      ...
      var Se = {
        ...
        positioners: de,
        afterInit(t, e, i) {
          i && (t.tooltip = new Me({ chart: t, options: i }));
        },
        beforeUpdate(t, e, i) {
      ...
      class Ae extends ft {
        static id = "category";
        static defaults = { ticks: { callback: Ce } };
        constructor(t) {
          super(t),
        ...
        parse(t, e) {
          ...
          return ((t, e) =>
            ...
            (e =
              isFinite(e) && i[e] === t
                ? e
                : De(i, t, (0, s.v)(e, t), this._addedLabels)),
            i.length - 1
          );
        }
        determineDataLimits() {
      ...
      function Pe(t, e, { horizontal: i, minRotation: n }) {
        const o = (0, s.t)(n),
        ...
        buildTicks() {
          ...
          const n = (function (t, e) {
            ...
            let y,
              ...
              M,
              S = (0, s.aH)((m - f) / p / g) * g;
            if (S < 1e-14 && !x && !_) return [{ value: f }, { value: m }];
            (M = Math.ceil(m / S) - Math.floor(f / S)),
              M > p && (S = (0, s.aH)((M * S) / p / g) * g),
              (0, s.k)(h) ||
                ((y = Math.pow(10, h)), (S = Math.ceil(S * y) / y)),
              "ticks" === n
                ? ((w = Math.floor(f / S) * S), (k = Math.ceil(m / S) * S))
                : ((w = f), (k = m)),
              x && _ && o && (0, s.aI)((r - a) / o, S / 1e3)
                ? ((M = Math.round(Math.min((r - a) / S, c))),
                  (S = (r - a) / M),
                  (w = a),
                  (k = r))
                : b
            ...
            for (
              ...
              (u && w !== a
                ? (i.push({ value: a }),
                  w < a && C++,
                  (0, s.aJ)(Math.round((w + C * S) * y) / y, a, Pe(a, v, t)) &&
                    C++)
                : w < a && C++);
              C < M;
              ++C
            ...
            return (
              _ && u && k !== r
                ? i.length && (0, s.aJ)(i[i.length - 1].value, r, Pe(r, v, t))
                  ? (i[i.length - 1].value = r)
                  : i.push({ value: r })
                : (_ && k !== r) || i.push({ value: k }),
              i
            );
          })(
            {
