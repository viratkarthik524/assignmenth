function UET(o) {
  ...
  this.insightsCookieMaxLength =
    this.cookieIdMaxLength + 1 + this.insightsDataMaxLength;
  ...
  this.checkuetHostdocumentload = function () {
    ...
    if (
      ...
      if (
        ...
        !n.uetConfig.tcf.enabled ||
        n.uetConfig.tcf.hasLoaded ||
        n.uetConfig.tcf.timeoutId
      ) {
  ...
  this.tcfCallback = function (n, t) {
    if (
      t &&
      (this.uetConfig.tcf.hasLoaded ||
        ((this.uetConfig.tcf.hasLoaded = !0),
        clearTimeout(this.uetConfig.tcf.timeoutId)),
      ...
      var i = function (t) {
        return (
          n.purpose.consents[t] === !0 ||
          n.purpose.legitimateInterests[t] === !0
        );
      };
      (n.vendor.consents[this.uetConfig.tcf.vendorId] === !0 ||
        n.vendor.legitimateInterests[this.uetConfig.tcf.vendorId] === !0) &&
        ((this.uetConfig.tcf.adStorageAllowed = i(1)),
        (this.uetConfig.tcf.measurementAllowed = i(7) && i(9) && i(10)),
        (this.uetConfig.tcf.personalizationAllowed = i(3) && i(4)));
      this.uetConfig.tcf.adStorageAllowed
  ...
  this.getClUrl = function (n) {
    return this.uetConfig.tcf.enabled === !0 &&
      this.uetConfig.tcf.hasLoaded === !0 &&
      this.uetConfig.tcf.gdprApplies === !0 &&
      this.uetConfig.tcf.adStorageAllowed !== !0
      ? n.replace(this.domain, this.domainCl)
      : n;
  };
  ...
  this.loadConfig = function () {
    ...
    o.hasOwnProperty("errorBeaconLevel") &&
      ((u = o.errorBeaconLevel),
      typeof u == "number" &&
        u % 1 == 0 &&
        u >= 0 &&
        u <= 2 &&
        (this.uetConfig.errorBeaconLevel = u));
    ...
    this.stringExists(i) &&
    (i.match(/^[0-9]{13}$/) ||
      i.match(/^[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$/))
      ? this.setCookie(
    ...
    for (f in o)
      l.hasOwnProperty(f) &&
        (this.beaconParams[f] = l[f] === 1 ? encodeURIComponent(o[f]) : o[f]);
    for (
      this.beaconParams.mid = this.getUuidV4(!0), t = undefined, a = 0;
      a < 5;
      a++
    )
    ...
    this.stringExists(o.ti) &&
      ...
      this.stringExists(this.uetConfig.batDebug) &&
        (y += "?bat_debug=" + this.uetConfig.batDebug),
      (n.src = y),
      (n.type = "text/javascript"),
      (n.async = 1),
    ...
    this.stringExists(this.uetConfig.batDebug) &&
      ...
      document.referrer &&
        window.URL &&
        ((h = new URL(document.referrer)),
        h.protocol === "https:" &&
          /\.microsoft\.com$/.test(h.hostname) &&
          (w = h.origin)),
  ...
  this.push = function () {
    ...
    this.uetInstance.documentLoaded ||
    t === "set" ||
    t === "consent" ||
    t === "config"
  ...
  this._push = function (n) {
    ...
    if (n[1] instanceof Array)
      if (n[0] === "event") {
        if (((o = n[1][1] || {}), (u = n[1][0]), u === null || u === undefined))
          return;
        ...
        for (i in n[1][0])
          this.knownParams.hasOwnProperty(i) &&
            ((this.pageLevelParams[i] = n[1][0][i]),
            i === "pid" &&
              this.pageLoadDispatch === !0 &&
              ((e = this.validateSubparams({ pid: n[1][0][i] }, "")),
        ...
        f === "default"
          ? (t.hasOwnProperty("ad_storage") &&
            ...
            t.hasOwnProperty("wait_for_update") &&
              ((r = parseInt(t.wait_for_update, 10)),
              !isNaN(r) &&
                r > 0 &&
                ((r = Math.min(r, 1e4)),
                (this.uetConfig.consent.waitForUpdate = r))))
          : f === "update" &&
            t.hasOwnProperty("ad_storage") &&
            ((this.uetConfig.consent.adStorageAllowed =
              t.ad_storage !== "denied"),
        ...
        if (((t = n[1][1]), (f = n[1][0]), t === null || typeof t != "object"))
          return;
        f === "tcf" &&
          ...
          ((this.uetConfig.tcf.enabled = !0),
          window.__tcfapi("addEventListener", 2, this.tcfCallback.bind(this)));
      }
  };
        ...
        this.uetConfig.enableAutoSpaTracking === !0 &&
          (("onpopstate" in window) &&
            window.addEventListener(
              "popstate",
              this.documentUrlChanged.bind(this, "popstate")
            ),
      ...
      if (typeof this.evq[r] == "object") {
        ...
        typeof this.evq[r] == "string" || this.evq[r] instanceof String
          ? (t !== undefined &&
            ...
            (f = this.evq[r]),
            t === undefined &&
            (f === "set" || f === "consent" || f === "config" || f === "event")
              ? (t = f)
  ...
  this.addUrlData = function (n, t) {
    ...
    if (((t = t === !0), (f = !1), window.window != window.top))
      try {
        for (
          e = 0, r = window.window;
          e <= 5 && r != null && r != window.top;
          e++, r = r.parent
        )
          if (
            r.document != null &&
            this.stringExists(r.document.referrer) &&
            r.document.referrer.toLowerCase() !== "about:blank"
          ) {
            i = r.document.referrer;
            (this.uetConfig.removeQueryFromUrls === !0 || t) &&
              (i = i.split("?")[0]);
    ...
    if (
      ...
      if (
        ...
        this.pageLevelParams.hasOwnProperty("pid") &&
          ...
          this.knownEvents[t].indexOf("pid") === -1 &&
        ...
        if (((l = !r && i.hasOwnProperty("page_path")), l)) {
          if (
            ...
            if (
              ((a = this.previousPage.toUpperCase()),
              (s = a.indexOf("%3A%2F%2F")),
              s === -1)
            )
              return;
              ...
              ? ((s += 9),
                ...
                (i.p =
                  v === -1
                    ...
                    : this.previousPage.substring(0, v) + i.page_path))
      ...
      this.uetConfig.tcf.enabled === !0 &&
        ...
        this.uetConfig.tcf.gdprApplies === !0 &&
          ((o.gdpr = "Y"),
          this.uetConfig.tcf.adStorageAllowed === !0 && (o.as = "G"),
          this.uetConfig.tcf.measurementAllowed === !0 && (o.ms = "G"),
          this.uetConfig.tcf.personalizationAllowed === !0 && (o.pz = "G")),
        (i.tcf = encodeURIComponent(
          this.removeTrailingAmp(this.stringifyToRequest(o))
        )));
  ...
  this.setCookie = function (n, t, i, r, u, f, e) {
    ...
    if (
      ((s = null),
      i > 0 && ((s = new Date()), s.setTime(s.getTime() + i * 1e3)),
      (l = new Date()),
      l.setTime(0),
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            !r &&
              (this._setCookie(n, f + t, s, o, this.uetConfig.cookieFlags),
  ...
  this.addCookieId = function (n, t, i, r, u) {
    ...
    return (this.stringExists(f) ||
      ((h = !1),
      (f = this.getLocalStorageBackup(r, this.insightsCookieMaxLength))),
    (s = this.insightsTrimCookie(f, !0)),
    (f = this.insightsTrimCookie(f, !1)),
    u === 0)
      ? (this.stringExists(f) &&
      ...
      : (this.stringExists(f) &&
        ...
        (this.getCookie(r, "", this.insightsCookieMaxLength) === o ||
          this.getLocalStorageBackup(r, this.insightsCookieMaxLength) === o) &&
          ((n[t] = encodeURIComponent(f)), this.stringExists(i) && (n[i] = e)),
        n);
  };
  ...
  this.firePidEvent = function (n) {
    var t = this.combine(this.beaconParams, { evt: "pid", pid: n }),
      i = this.removeTrailingAmp(
        this.getClUrl(this.urlPrefix) + this.stringifyToRequest(t)
      );
    this.invisibleDiv || this.createInvisibleDiv(document.body);
  ...
  this.documentUrlChanged = function () {
    ...
    t != n &&
      ...
      this.push("event", "page_view", { page_path: i }));
  };
  ...
  this.insightsGetCookie = function (n) {
    ...
    return (
      this.stringExists(t) ||
        (t = this.getLocalStorageBackup(i, this.insightsCookieMaxLength)),
      this.insightsTrimCookie(t, !0)
    );
  };
  this.insightsSetCookie = function (n, t) {
    var f, e;
    if (
      this.isAdStorageAllowed() &&
      this.stringExists(n) &&
      !(n.length > this.insightsDataMaxLength)
    ) {
      ...
      this.stringExists(i) ||
        ((u = !1),
        (i = this.getLocalStorageBackup(r, this.insightsCookieMaxLength)));
      ...
      this.setCookie(
        r,
        e,
        t === 0 ? this.sessionExpirationTime : this.visitorExpirationTime,
        u,
        !0,
        "",
        this.insightsCookieMaxLength
  ...
  this.setExternalMid = function (n) {
    this.stringExists(n) &&
      n.match(/^[0-9a-fA-F]{8}-?([0-9a-fA-F]{4}-?){3}[0-9a-fA-F]{12}$/) &&
      ((this.beaconParams.mid = n), (this.midOverride = !0));
  };
  this.trimTagId(o);
  this.isDuplicate(o)
